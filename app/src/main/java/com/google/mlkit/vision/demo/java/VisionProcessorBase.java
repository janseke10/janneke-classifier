...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
  ...
  public void processBitmap(Bitmap bitmap, final GraphicOverlay graphicOverlay) {
    System.out.println("process bitmap");
    long frameStartMs = SystemClock.elapsedRealtime();

    if (isMlImageEnabled(graphicOverlay.getContext())) {
      System.out.println("process bitmap if");
    ...
    System.out.println("process bitmap no if");
    requestDetectInImage(
  ...
  private void processImage(
    ...
    if (isMlImageEnabled(graphicOverlay.getContext())) {
      System.out.println("process image with if");
      MlImage mlImage =
    ...
    System.out.println("process image no if");
    requestDetectInImage(
  ...
  public void processImageProxy(ImageProxy image, GraphicOverlay graphicOverlay) {
    System.out.println("process image proxy");
    long frameStartMs = SystemClock.elapsedRealtime();
    if (isShutdown) {
      image.close();
      return;
    ...
    if (isMlImageEnabled(graphicOverlay.getContext())) {
      System.out.println("process image proxy if ");
      MlImage mlImage =
  ...
  private Task<T> requestDetectInImage(
      ...
      long frameStartMs) {
    System.out.println("requestDetectInImage inputImage");
  ...
  private Task<T> requestDetectInImage(
      ...
      boolean shouldShowFps,
      long frameStartMs) {
      System.out.println("requestDetectInImage mlImage");
      return setUpListener(
              detectInImage(image, frameStartMs), graphicOverlay, originalCameraImage, shouldShowFps, frameStartMs);
  }
  ...
  protected Task<T> detectInImage(MlImage image, long frameStartMs) {
