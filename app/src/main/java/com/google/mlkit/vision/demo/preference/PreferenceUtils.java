...
//  public static CustomPoseDetectorOptions getCustomPoseDetectorOptionsForLivePreview(Context context) {
//    int performanceMode =
//            getModeTypePreferenceValue(
//                    context,
//                    R.string.pref_key_live_preview_pose_detection_performance_mode,
//                    POSE_DETECTOR_PERFORMANCE_MODE_FAST);
//    if (performanceMode == POSE_DETECTOR_PERFORMANCE_MODE_FAST) {
//      return new CustomPoseDetectorOptions.Builder()
//              .setDetectorMode(CustomPoseDetectorOptions.STREAM_MODE)
//              .build();
//    } else {
//      System.out.println("uhoh custom pose detector else...?");
//      return new CustomPoseDetectorOptions.Builder()
//              .setDetectorMode(CustomPoseDetectorOptions.STREAM_MODE)
//              .build();
//    }
